# Script to aggregate and plot ST-GPR results for US care hours (112 topcode) - input for opportunity cost model
...
raw_input = fread(paste0(FILEPATH,"/caregiving_data_112_keep_outliers.csv"))
stage1_input = fread(paste0(FILEPATH,"caregiving_predictions_112_keep_outliers.csv"))
gpr_means = fread(paste0(FILEPATH,'stgpr_cg_gpr_run_00', model_num, '_keep_outliers.csv'))
...
fwrite(final_estimates, file = paste0(FILEPATH,"care_hours_112/aggregated/US_caregiving_hours_run_00", model_num, "_keep_outliers.csv"))
...
pdf(paste0(data_dir,"brfss_cg_estimates_states_run",model_num,"_aggregated_keep_outliers.pdf"))
