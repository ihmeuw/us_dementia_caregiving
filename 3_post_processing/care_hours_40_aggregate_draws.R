# Script to aggregate ST-GPR draws for US care hours (40 topcode)
...
draws = fread(paste0(stgpr_out_path, "stgpr_cg_draws_run_0",model_num,outlier,".csv"))
...
fwrite(final_estimates, paste0(stgpr_out_path,"aggregated/US_caregiving_hours_run_0", 
